...
\newcommand{\studentFirsName}{Jan}
\newcommand{\studentSecondName}{Nauber}
\newcommand{\studentMatrikelnummer}{3003433}
...
\include{content/chapters/titlePage}
\tableofcontents
...
\include{content/chapters/chapter2} %Materials and Methods
\include{content/chapters/chapter3}	%Approach
\include{content/chapters/chapter4} %Implementation
\include{content/chapters/chapter5} %Evaluation
\include{content/chapters/chapter6}	%Discussion
\include{content/chapters/chapter7}	%Aknowledgments
